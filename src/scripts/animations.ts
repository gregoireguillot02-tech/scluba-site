...
function initPhoneShowcase() {
  ...
  // V4.2 Néon sweep — déplacé en CSS pur (conic-gradient + @property),
  // animation continue 4s @keyframes neonSweep dans PhoneShowcase.astro.
  // Plus de scrub GSAP nécessaire.
