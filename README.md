...
Marketing site (`klubba.golf`) and internal ops dashboard (`klubba.golf/ops`).
...
3. **Configure Supabase Auth redirect URLs** (Supabase dashboard →
   ...
   - Site URL: `https://klubba.golf`
   - Add to redirect allowlist: `https://klubba.golf/ops/auth/callback`
